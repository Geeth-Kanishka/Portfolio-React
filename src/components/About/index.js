  ...
  return (
    ...
    <div className="container about-page">
      <div className="text-zone">
        ...
        <p align="LEFT">
        Software Engineering Undergraduate at Informatics Institute of Technology (IIT) | University of Westminster
        </p>
        <p>
          Intern at John Keells IT ( August 2022-August 2023 )
        </p>
      </div>
